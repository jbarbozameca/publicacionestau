...
XLSX = sys.argv[1] if len(sys.argv) > 1 else '/root/.claude/uploads/5edf0ae5-463b-5fda-9942-fe3bcd59da2e/c5c445f7-TRANSPARENCIA__INVESTIGACIONES__Tau_20242026.xlsx'
OUT = sys.argv[2] if len(sys.argv) > 2 else '/home/claude/data.json'
